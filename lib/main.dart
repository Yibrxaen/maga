...
class AppData {
  ...
  static final Map<String, List<Map<String, String>>> _data = {
    "แอกชัน": [
      ...
      {"t": "One Punch Man", "img": "https://cdn.myanimelist.net/images/anime/12/76649.jpg"},
    ...
    "ไซไฟ": [
      ...
      {"t": "Code Geass", "img": "https://cdn.myanimelist.net/images/anime/18/43977.jpg"},
    ],
    "เหนือธรรมชาติ": [
      ...
      {"t": "Fate/Zero", "img": "https://cdn.myanimelist.net/images/anime/2/73250.jpg"},
      {"t": "Noragami S2", "img": "https://cdn.myanimelist.net/images/anime/7/77820.jpg"},
    ],
    "ชีวิตประจำวัน": [
      ...
      {"t": "Barakamon", "img": "https://cdn.myanimelist.net/images/anime/11/64345.jpg"},
...
class _SearchPageState extends State<SearchPage> {
  ...
  void _toDetail(Anime a) { a.views++; Navigator.push(context, MaterialPageRoute(builder: (c) => DetailPage(manga: a))).then((_) => widget.onUpdate()); }
...
class FullListPage extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text(title)), body: GridView.builder(padding: EdgeInsets.all(15), gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3, childAspectRatio: 0.6, crossAxisSpacing: 10, mainAxisSpacing: 15), itemCount: animeList.length, itemBuilder: (c, i) => GestureDetector(onTap: () { animeList[i].views++; Navigator.push(context, MaterialPageRoute(builder: (c) => DetailPage(manga: animeList[i]))).then((_) => onUpdate()); }, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Expanded(child: ClipRRect(borderRadius: BorderRadius.circular(10), child: buildImage(animeList[i].imageUrl, animeList[i].title))), SizedBox(height: 5), Text(animeList[i].title, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)), Text(animeList[i].category, style: TextStyle(fontSize: 10, color: Colors.greenAccent))]))));
  }
}
...
class ProfilePage extends StatelessWidget {
  ...
  Widget _statItem(String label, String val, IconData icon, Color col) => Column(children: [
    Icon(icon, color: col),
    SizedBox(height: 5),
  ...
  Widget _menuItem(IconData icon, String title, String extra, Color iconCol) => ListTile(
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          ...
          Padding(padding: EdgeInsets.symmetric(horizontal: 20), child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
            _statItem("ตั๋วฟรี", "3", Icons.confirmation_number, Colors.blue),
            _statItem("คะแนน", "1,250", Icons.star, Colors.yellow),
          ])),
          SizedBox(height: 25), Divider(thickness: 8, color: Colors.white10),
          _menuItem(Icons.bookmark, "เรื่องที่บันทึกไว้", "$savedCount เรื่อง", Colors.greenAccent),
          _menuItem(Icons.history, "ประวัติการอ่าน", "24 เรื่อง", Colors.white),
